...
export function GreenManifesto() {
  return (
    <section className="bg-[#163300] py-20 sm:py-28 text-white border-b border-black/20 overflow-hidden">
      <div className="max-w-[1240px] mx-auto px-4 sm:px-8">
        
        {/* 1. Header: Massive Lime Typography + Supporting Paragraph */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-start mb-12 sm:mb-16">
          <div className="lg:col-span-7 space-y-3">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#9FE870]/10 text-xs font-bold text-[#9FE870]">
              <Leaf className="w-3.5 h-3.5 text-[#9FE870]" />
              <span>The Zero-Paper Pledge</span>
            </div>
            <h2 className="font-parafina font-black text-[42px] sm:text-[68px] md:text-[80px] lg:text-[96px] text-[#9FE870] tracking-[-0.04em] uppercase leading-[0.92]">
              NETWORKING
              <br />
              WITHOUT
              <br />
          ...
          <div className="lg:col-span-5 text-white text-base sm:text-[18px] leading-relaxed font-normal pt-4 sm:pt-8">
            <p>

    ...
    <div className="w-full space-y-2">
      ...
      <div className="relative">
        <textarea
          ref={ref}
          className={clsx(
            "min-h-20 w-full rounded-xl border border-white/[0.08] bg-white/[0.02] px-3 py-2 text-xs leading-5 text-white placeholder:text-slate-500 transition-all duration-200 focus:border-brand-500/40 focus:bg-white/[0.04] focus:outline-none focus:ring-2 focus:ring-brand-500/10 hover:border-white/[0.15] resize-y",

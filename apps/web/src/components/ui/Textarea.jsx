    ...
    <div className="w-full space-y-2">
      ...
      <div className="relative">
        <textarea
          ref={ref}
          className={clsx(
            "min-h-20 w-full rounded-ds-input border border-white/[0.08] bg-white/[0.02] px-3.5 py-2.5 text-xs leading-5 text-white placeholder:text-slate-500 transition-all duration-150 ease-ds-out focus:border-primary focus:bg-white/[0.04] focus:outline-none focus:ring-2 focus:ring-primary/10 hover:border-white/[0.15] resize-y",

...
export function Card({ className, children, hoverEffect = false, ...props }) {
  return (
    <div
      className={clsx(
        "relative rounded-3xl border border-white/[0.05] bg-gradient-to-b from-white/[0.04] to-transparent p-6 shadow-[0_12px_40px_rgba(0,0,0,0.3)] backdrop-blur-xl transition-all duration-300 ease-out",
